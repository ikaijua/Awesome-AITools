...
| 名称 | 描述 | 链接 | 费用 |
| --- | --- | --- | --- |
| dexhunter/seedance2-skill | 用于编写更好 Seedance 2.0 视频生成 prompt 的 Skill。覆盖即梦 / Seedance 2.0 输入约束、@ 引用语法、镜头语言、prompt 结构，以及广告、短剧、MV、教育视频等模板；兼容 Claude Code、Cursor、Cline 等 Agent 工具。 | [Github](https://github.com/dexhunter/seedance2-skill) ![GitHub Repo stars](https://img.shields.io/github/stars/dexhunter/seedance2-skill?style=social) | Free |
