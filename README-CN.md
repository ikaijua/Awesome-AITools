...
| Orbi | 自托管、fair-code 的 AI 编程智能体。给 GitHub Issue 打上 `ai-ready` 标签，它就写改动、开 PR、跑一轮独立评审、合并并打 Release 标签，模型和仓库都用你自己的。源码按 Sustainable Use License 公开，另有托管版 Orbi Cloud。 | [URL](https://orbi.build/zh/?ref=awesome-aitools) [Github](https://github.com/orbi-build/orbi) ![GitHub Repo stars](https://img.shields.io/github/stars/orbi-build/orbi?style=social) | 免费/付费 |
