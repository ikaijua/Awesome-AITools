...
| Agent Island | AI 编程状态伴侣。读取 Claude Code、Codex、Antigravity、Grok 与 Cursor 在本机已写入的会话日志，在菜单栏或刘海显示每个会话的状态，轮到你回话时主动提醒，额度与费用估算全部在本机计算。无需账号，不上传会话数据。原生 macOS 与 Windows，MIT 开源。 | [URL](https://agent-island.dev) [Github](https://github.com/tristan666666/agent-island) ![GitHub Repo stars](https://img.shields.io/github/stars/tristan666666/agent-island?style=social) | 免费 |
