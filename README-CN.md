...
|Antigravity|Google 推出的以智能体为先的 AI 编程平台，基于 Gemini 3，用于替代 Gemini CLI。以深度改造的、基于 VS Code 的 IDE 形态交付（Windsurf 衍生产品），提供 Editor 与 Manager 双视图、可驱动编辑器/终端/浏览器的自主智能体，以及可核验的 Artifacts（计划、截图、录屏）。同时支持 Claude Sonnet 4.6、Claude Opus 4.6 与 GPT-OSS-120B。[入门介绍](docs/antigravity/README-CN.md)|[URL](https://antigravity.google/)|预览期免费|
