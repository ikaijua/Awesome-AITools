...
| agenttrace | 本地 TUI 形式的 AI 编码智能体可观测工具。读取 Claude Code、Codex CLI、Gemini CLI、Qwen Code、Cline、Aider、Cursor exports、OpenCode、OpenClaw、Kimi CLI、Pi 和 JSON/JSONL traces 等会话日志，按成本、token、延迟、工具失败、异常、健康度和 CI 报告进行排查。 | [Github](https://github.com/luoyuctl/agenttrace) ![GitHub Repo stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=social) | 免费 |
