...
| 名称 | 说明 | 链接 | 费用 |
| --- | --- | --- | --- |
| ModelRush | 面向文本、图像、视频和语音模型的托管 API 网关与浏览器 Playground。聊天接口兼容 OpenAI；媒体接口因模型而异。专有服务，包含有年龄限制的 Spicy 目录。 | [官网](https://modelrush.ai/) [文档](https://modelrush.ai/docs) | 预付费积分按量计费；无长期免费层或试用 |
