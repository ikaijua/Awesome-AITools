...
AI 智能体正从单轮聊天机器人演变为可长期运行、使用工具的系统。本节按角色分组：修改代码的编程智能体、自主执行任务的通用框架与平台，以及让它们更可靠的基础设施（记忆、编排、上下文、安全）。
...
|MiniMax Agent|Minimax 的 Agent 助手|[URL](https://agent.minimaxi.com/)|免费/付费|
...
|MastraAI|Mastra 是一个 opinionated TypeScript 框架，帮助你快速构建 AI 应用和功能。提供工作流、智能体、RAG、集成和评估等原语。|[Github](https://github.com/mastra-ai/mastra) ![GitHub Repo stars](https://img.shields.io/github/stars/mastra-ai/mastra?style=social)|免费|
...
|AgentsMesh|AI 智能体工作力平台。可自托管的远程 AI 工作站（AgentPods），具备 PTY 沙箱 + git worktree 隔离、频道与 Pod 绑定的多智能体协作、内置看板与 MR/PR 集成，每个 Pod 配备 MCP 服务器。支持 Claude Code、Codex CLI、Gemini CLI、Aider、OpenCode。 | [Github](https://github.com/AgentsMesh/AgentsMesh) ![GitHub Repo stars](https://img.shields.io/github/stars/AgentsMesh/AgentsMesh?style=social) | 免费（BSL-1.1） |
