...
| 腾讯元宝/混元 |腾讯元宝提供了DeepSeek R1和腾讯自家的混元模型可使用；腾讯混元 AI Studio 提供的各种 AI 工具，包括 AI 对话助手、文生图、文/图生视频等各种模型和工具|[元宝对话页面](https://hunyuan.tencent.com/bot) <br>[混元 AI Studio](https://hunyuan.tencent.com/)|免费|
