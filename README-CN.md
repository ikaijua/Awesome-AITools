...
| DocGPT.ai | 面向 Google Sheets、Docs、Gmail、Slides 和 Forms 的 AI 生产力插件。GPT for Sheets 可用于公式、线索丰富和批量表格工作流；GPT for Gmail 可用于邮件草稿、总结和回复。 | [URL](https://docgpt.ai/) | 免费/付费 |
