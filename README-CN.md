...
| Requesty | 托管的 OpenAI 兼容 LLM 网关，可路由到 30+ 家提供商的 600+ 模型，支持故障转移、负载均衡、缓存和费用追踪。同时提供 Anthropic Messages API 和欧盟节点。免费套餐仅含免费模型（每天 200 次请求）。 | [URL](https://www.requesty.ai/) | 免费/付费 |
