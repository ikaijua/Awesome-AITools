...
| Grout | 面向学生、教师和学校的离线 AI 学习套件，支持 Windows 和 macOS。200 多个模型在本地运行：GroutApp 用自己的笔记和教材学习（支持手写识别），GroutCode 提供由编译器检查的编程实验，GroutFilm 用于 AI 视频和音频剪辑。可选云端模块提供更大的模型。 | [URL](https://grout.app/) | 付费 |
