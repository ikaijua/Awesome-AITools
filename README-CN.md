...
| LWC (Local Wiki CLI) | 面向编程智能体的本地优先、来源可追溯的项目记忆工具。以 Markdown/SQLite 持久保存带引用和来源链的知识，通过 MCP 提供有边界的只读检索，并可选构建文档知识图谱与代码图谱。支持 Codex、Claude Code、Cursor、OpenCode、Gemini CLI、Kiro、Hermes、Antigravity 和 pi。 | [Github](https://github.com/JanYork/llm-wiki-cli) ![GitHub Repo stars](https://img.shields.io/github/stars/JanYork/llm-wiki-cli?style=social) | 免费 |
