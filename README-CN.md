...
| DSH Studio | 用于在本地安装、监控和托管 DeepSeek Harness 的开源桌面外壳。提供一键安装、运行状态检查、日志、进程控制，以及 Windows、macOS 和 Linux 的打包发行版。 | [Github](https://github.com/Moresyl/dsh-studio) ![GitHub Repo stars](https://img.shields.io/github/stars/Moresyl/dsh-studio?style=social) | 免费 |
