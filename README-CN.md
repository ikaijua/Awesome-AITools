...
| Open Index | 面向特定领域 AI 智能体的开源结构化上下文层。基于类型化 schema、实体和关系构建可搜索、持续改进的上下文图，支持 SQLite 或 OpenSearch 后端、连接器、CLI/UI，以及可读写的 MCP 接口。 | [Github](https://github.com/DrDroidLab/open-index) ![GitHub Repo stars](https://img.shields.io/github/stars/DrDroidLab/open-index?style=social) | 免费 |
