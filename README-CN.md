...
| CliDeck | 本地浏览器仪表板，用于在类似WhatsApp的界面中管理多个AI编程代理（Claude Code、Codex、Gemini CLI、OpenCode）。实时状态检测、会话恢复、代理间自动导航路由，以及手机远程控制。 |[Github](https://github.com/rustykuntz/clideck) ![GitHub Repo stars](https://img.shields.io/github/stars/rustykuntz/clideck?style=social)|免费|
