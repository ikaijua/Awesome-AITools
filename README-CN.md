...
| Off Grid AI Desktop | 隐私优先、本地运行的 macOS 应用，在本机完成大语言模型对话、图像生成、语音听写和个人记忆/RAG，所有数据都不会离开你的设备。 | [Github](https://github.com/off-grid-ai/off-grid-ai-desktop) ![GitHub Repo stars](https://img.shields.io/github/stars/off-grid-ai/off-grid-ai-desktop?style=social) | 免费 |
