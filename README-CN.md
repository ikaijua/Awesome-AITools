...
| Muse Code | Meta 推出的基于终端的 AI 编程智能体（Beta），由 Muse Spark 1.2 驱动。支持跨大型代码库的规划、编写代码与验证结果，具备持久异步后台代理和追加式本地事件日志，可在崩溃后恢复。支持 macOS/Linux；按量付费，另有 Contributor 档位以允许使用提示/补全训练来换取更低价格。[入门介绍](docs/muse-code/README-CN.md) | [URL](https://www.meta.ai/muse/code) | 免费/付费 |
