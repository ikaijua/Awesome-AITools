...
| Casibase | [Casibase](https://casibase.org/) 是一个开源的AI知识库和对话系统,它结合了最新的RAG(检索增强生成)技术、SSO(单点登录)功能,并支持多种主流AI模型。| [GitHub](https://github.com/casibase/casibase) ![GitHub Repo stars](https://img.shields.io/github/stars/casibase/casibase?style=social)| 免费 |
