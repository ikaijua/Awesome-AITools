...
| shortshort | 网页端短视频工作室，把一段长视频（MP4/MOV/WebM，最长 3 小时或 2GB）剪成 15-90 秒的 9:16 竖屏短视频。基于逐词转写在完整句子处切分，通过追踪画面中的人脸重新构图，识别到幻灯片、屏幕和大全景时保留完整画面，并提供四种逐词字幕样式。导出 MP4 1080x1920 30fps；渲染前每个片段都可编辑，手动剪辑器及其导出无需注册账号。 | [URL](https://www.shortshort.io) | 免费/付费 |
