...
| NoteGen | 开源、本地优先的 Markdown 笔记应用，可捕获零散信息并借助 AI 整理成结构化笔记。 | [GitHub](https://github.com/codexu/note-gen) ![GitHub Repo stars](https://img.shields.io/github/stars/codexu/note-gen?style=social) | 免费 |
