...
| atdy/maoxuan-product-agent | 从《矛盾论》《实践论》完整推理结构蒸馏的中文产品决策 Agent Skill，默认以现代产品语言处理需求优先级、增长、运营、数据、项目推进与组织协作问题。支持 Codex、Claude Code、Cursor 等兼容工具，包含 36 个场景测试和 12 个可独立检索的案例页。 | [Github](https://github.com/atdy/maoxuan-product-agent) ![GitHub Repo stars](https://img.shields.io/github/stars/atdy/maoxuan-product-agent?style=social) | 免费 |
