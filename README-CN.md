...
| Qoder CN（原通义灵码）| 阿里云推出的 AI 编程智能体。支持自主使用多种内置编程工具、自动感知和使用 MCP 工具、执行终端命令，可完成端到端编程任务。提供 VS Code / JetBrains 插件、桌面端和 CLI 等多种形态。 | [URL](https://qoder.com.cn/) | 免费/付费 |
...
| Qoder CN（原通义灵码）|阿里云开发的 AI 编程助手，2026 年 5 月由“通义灵码”升级更名。支持行级/函数级代码补全、单元测试、代码注释生成、Agent 模式及多模型切换，兼容 VS Code、JetBrains IDEs 等主流工具|[URL](https://qoder.com.cn/)|免费/付费|
