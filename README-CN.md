...
| AICraft | 桌面 AI 能力启动器，像加载 Minecraft mod 一样管理 LLM 的 Skill、MCP、RAG、记忆。支持 DeepSeek 一键接入、角色情绪画框、三层记忆、Token 计费，全可视化热插拔，解压即用无需安装。 | [Github](https://github.com/Easlie114514/AICraft) ![GitHub Repo stars](https://img.shields.io/github/stars/Easlie114514/AICraft?style=social) | 免费 |
