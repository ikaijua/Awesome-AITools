...
| DeepSeek Harness Desktop | 🌱 DeepSeek Harness 的独立 Tauri 2 桌面发行版——将完整 Web UI、受监管的本地 sidecar 与内置 Node.js 24 运行时打包为自包含桌面应用。本地优先（仅监听 127.0.0.1）、跨平台（macOS/Linux/Windows）、MIT 开源。 | [Github](https://github.com/fendouai/deepseek-harness-desktop) ![GitHub Repo stars](https://img.shields.io/github/stars/fendouai/deepseek-harness-desktop?style=social) | 免费 |
