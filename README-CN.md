...
|ChatGPT-Next-Web|一键拥有你自己的跨平台 ChatGPT/Gemini 应用。|[Github](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) ![GitHub Repo stars](https://img.shields.io/github/stars/ChatGPTNextWeb/ChatGPT-Next-Web?style=social)|免费|
...
| 名称 | 说明 | 链接 | 费用 | 
| ---- | ----------------------------- | --- | --- | 
|suno.ai|[URL](https://www.suno.ai/)|使用AI通过文本来创作音乐|免费/付费|
