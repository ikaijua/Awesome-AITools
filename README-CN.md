...
| Awesome Agentic Engineering | 面向 AI Agent 的 MIT 开源生产就绪门禁工具，不是资源清单。提供零依赖评分与风险 Profile GitHub Action、fail-closed 初始化器、提示注入 Fixture、机器可读 Eval Result 和可复现 LangGraph Trace。[中文指南](https://lindixu6-hash.github.io/awesome-agentic-engineering/zh/langgraph-eval/) | [Github](https://github.com/lindixu6-hash/awesome-agentic-engineering) ![GitHub Repo stars](https://img.shields.io/github/stars/lindixu6-hash/awesome-agentic-engineering?style=social) | 免费 |
