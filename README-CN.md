...
| Ontoly | TypeScript 原生软件智能引擎，可从代码库生成确定性的 Software Graph，并通过 CLI、MCP 和 Agent Skills 支持架构审查、请求链路追踪、依赖分析和影响分析。 | [Github](https://github.com/0xsarwagya/ontoly) ![GitHub Repo stars](https://img.shields.io/github/stars/0xsarwagya/ontoly?style=social) | 免费 |
