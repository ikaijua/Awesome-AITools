...
| HoverStare | 开源的仓库感知 AI PR 审查 bot，Rust 编写。审查 Agent 带只读仓库工具，上报前先查证，多路投票加独立 verifier 复核，误报率低；行内评论精确锚定，指纹增量追踪、修复后自动 resolve。支持 GitHub Action / GitHub App / 自部署 webhook 服务三种形态，可接 Anthropic 或任意 OpenAI 兼容端点（Kimi、DeepSeek、OpenRouter）。 | [GitHub](https://github.com/liuchong/hoverstare) <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/liuchong/hoverstare?style=social"> | 免费 |
