...
| Bernstein | 开源的 CLI 编码智能体多智能体编排器。在并行 git worktree 中协调 37 个 CLI 智能体（Claude Code、Codex CLI、Gemini CLI、GitHub Copilot CLI、Cursor、Aider、OpenHands、OpenCode、Goose、Qwen、Ollama 等）。确定性 Python 调度器，原生 MCP 服务器，质量门控，带预算的成本追踪，基于文件的状态。Apache 2.0。 | [Github](https://github.com/sipyourdrink-ltd/bernstein) ![GitHub Repo stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein?style=social) | 免费 |
