...
| 通义千问 |阿里的大语言模型 <br> qwen.ai中可体验最新的模型和不同的模型，包括QwQ-32B、Qwen2.5-Max、Qwen2.5-Plus、 Qwen2.5-VL-72B-Instruct等|1. [qwen.ai可选择不同模型](https://chat.qwen.ai/)；<br>2. [通义网页版](https://tongyi.aliyun.com/)|免费|
