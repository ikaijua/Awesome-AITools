...
| XiuRouter | 面向应用与编程工具的托管式多协议大模型 API 网关。支持 OpenAI Responses 与 Chat Completions、Anthropic Messages、Gemini GenerateContent、限定作用域的 API Key、按量计费、请求级用量与费用记录，并提供常用编程工具接入指南。当前模型与价格以实时目录为准。 | [官网](https://router.xiu.ai/) [文档](https://docs.xiu.ai/router/) | 付费 |
