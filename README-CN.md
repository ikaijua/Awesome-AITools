...
| Bernstein | 面向 40+ 个 CLI 编码智能体（Claude Code、Codex、Cursor、Aider、Gemini、Copilot、OpenHands、Goose、Qwen、Ollama 等）的确定性编排器。在并行 git worktree 中运行，并合并通过测试的代码。原生 MCP 服务器、成本预算、质量门控、基于文件的状态。Apache 2.0。[官网](https://bernstein.run) | [Github](https://github.com/sipyourdrink-ltd/bernstein) ![GitHub Repo stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein?style=social) | 免费 |
