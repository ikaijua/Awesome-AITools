...
| Tapproval | Claude Code 的 Apple Watch 应用：权限请求、提问和计划直接推送到手表，每条标注五级风险之一，轻点即可回复。默认不会自动批准任何操作。无需账号；开源辅助程序仅使用 Python 标准库，可直连手表或通过你自己的 iCloud 通信。 | [URL](https://tapproval.thoughtfulsteward.org) [Github](https://github.com/marcobelini/tapproval-helper) ![GitHub Repo stars](https://img.shields.io/github/stars/marcobelini/tapproval-helper?style=social) | 免费 |
