...
- Added Meta Muse (personal AI agent by Meta; topped the US App Store free chart ~10 days after launch) to the AI Assistants & Commercial Models section, with intros in Discussions #1010 (CN) / #1011 (EN) (both EN/CN)
- Added Jev (TypeSafe AI's "System One" decision model, 🌱 early access) to the AI Assistants & Commercial Models section, with deep dives in Discussions #996 (CN) / #1012 (EN) (both EN/CN)
