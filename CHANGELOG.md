...
## September 2026
- Added VideoText tools (Video to Transcript, Guideline Format, Voice Recorder, Video to Subtitles, Fix Subtitles, Burn Subtitles, Translate Subtitles, Compress Video) to Speech Recognition / 语音识别-生成字幕, Speech translation / 语音翻译, and Video Creation (both EN/CN)
