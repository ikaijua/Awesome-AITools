...
- Added AI Novel Writer to the Writing section: an open-source long-form fiction desktop workspace with Windows/macOS releases and optional Ollama support (both EN/CN)
