...
## September 2026
- Added Document Translator to Translation section: a free browser-based document translator for PDF/Word/TXT/Markdown that keeps paragraph structure and runs on-device in Chrome (both EN/CN)
