...
| MCP Lens | Open-source DeepSeek Harness plugin that makes configured MCP tools available through two model-facing interfaces: `mcp_search` for discovery and `mcp_call` for invocation. Explicit allow and deny filters are applied before tools can be discovered or called. | [Github](https://github.com/labmimors/dsh-mcp-lens) ![GitHub Repo stars](https://img.shields.io/github/stars/labmimors/dsh-mcp-lens?style=social) | Free |
