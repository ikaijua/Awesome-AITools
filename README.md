...
| qq-ai-bot | Production-grade self-hosted QQ AI bot that bridges OneBot 11 / NapCat / LLOneBot with ACP-compatible agents. Supports persistent sessions, progress streaming, image handoff, Prometheus metrics, and a Docker quickstart stack. | [Github](https://github.com/happysnaker/qq-ai-bot) ![GitHub Repo stars](https://img.shields.io/github/stars/happysnaker/qq-ai-bot?style=social) | Free |
