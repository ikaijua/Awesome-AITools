...
| Tura | Local-first open-source coding agent in Rust with CLI, TUI, and GUI interfaces, project-scoped instructions, built-in verification, and reproducible benchmark results. | [Github](https://github.com/Tura-AI/tura) ![GitHub Repo stars](https://img.shields.io/github/stars/Tura-AI/tura?style=social) | Free |
