...
| Casibase | [Casibase](https://casibase.org/) is an open source AI knowledge base and dialogue system that combines the latest RAG technology, SSO, and support for a wide range of mainstream AI models.| [GitHub](https://github.com/casibase/casibase) ![GitHub Repo stars](https://img.shields.io/github/stars/casibase/casibase?style=social)| Free |
