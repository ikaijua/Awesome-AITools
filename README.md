...
| APort | Open-source pre-action authorization layer for AI agents. Issues portable agent passports with capability/limit policies and runs sub-100ms policy checks before tool calls. Includes 40+ blocked-pattern guardrails and pre-built policy packs for refunds, data export, and PR merges. Works with OpenClaw, Claude Code, LangChain, CrewAI, and any framework via SDK. [Website](https://aport.io) | [GitHub](https://github.com/aporthq/aport-agent-guardrails) ![GitHub Repo stars](https://img.shields.io/github/stars/aporthq/aport-agent-guardrails?style=social) | Free |
