...
| Markstream | Open-source streaming Markdown renderer for AI chat interfaces. Handles incomplete Markdown during token streaming and provides maintained packages for Vue, React, Svelte, and Angular, with Mermaid, KaTeX, code highlighting, safe HTML, and SSR support. | [Docs](https://markstream.simonhe.me/) [Playground](https://markstream-vue.simonhe.me/) [Github](https://github.com/Simon-He95/markstream-vue) ![GitHub Repo stars](https://img.shields.io/github/stars/Simon-He95/markstream-vue?style=social) | Free |
