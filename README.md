...
| agenttrace | Local TUI observability for AI coding agents. Reviews Claude Code, Codex CLI, Gemini CLI, Qwen Code, Cline, Aider, Cursor exports, OpenCode, OpenClaw, Kimi CLI, Pi, and JSON/JSONL traces across cost, tokens, latency, tool failures, anomalies, health, and CI reports. | [Github](https://github.com/luoyuctl/agenttrace) ![GitHub Repo stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=social) | Free |
