...
| CodeTrain | AI coding tutor that teaches developers on their own codebase. It plans a lesson of 2-6 small steps, runs and grades every line you type, and never writes the code for you; when you are stuck it shrinks the step instead of giving the answer. Free tier gives 10 lessons a month with no card, and Python and JavaScript run in your browser. | [URL](https://codetrain.ai) | Free/Paid |
