...
AI agents are evolving from single-turn chatbots into long-running, tool-using systems. This section groups them by role: coding agents that modify code, general agent frameworks that autonomously execute tasks, and the infrastructure (memory, orchestration, context, safety) that makes them reliable.
