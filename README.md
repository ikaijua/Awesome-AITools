...
| poorcoder| Set of tools to work with code in local Git repo using normal web LLM chat subscriptions| [GitHub](https://github.com/vgrichina/poorcoder) ![GitHub Repo stars](https://img.shields.io/github/stars/vgrichina/poorcoder?style=social)|Free|
