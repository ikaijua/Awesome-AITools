...
| Poket Dev | Unlimited software development subscription: flat monthly fee, one active request at a time, unlimited request cards delivered one by one via a Trello board, code delivered through a private GitHub repo. Python-first scope: AI/ML, backends (Django/FastAPI/Flask), automation, data engineering/ETL, cloud/DevOps. | [URL](https://poketdev.com) | Paid |
