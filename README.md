...
| Persona |Local-first personal workspace: notes and tasks as plain Markdown on your machine, with an AI chat grounded in your own files. Works with Ollama or any OpenAI-compatible API.| [Github](https://github.com/jayamitkatariya/personacli) ![GitHub Repo stars](https://img.shields.io/github/stars/jayamitkatariya/personacli?style=social)| Free |
