...
| A3M Router | Adaptive multi-model LLM router with parallel ensemble orchestration, Shapley value credit allocation, and game-theoretic risk profiling. 47+ providers, circuit breaker, semantic cache, guardrails, ObsidianVault memory, multimodal routing. Highest robustness (0.8524) on RouterArena. 19K+ npm downloads. | [GitHub](https://github.com/Das-rebel/a3m-router) <br> ![GitHub Repo stars](https://img.shields.io/github/stars/Das-rebel/a3m-router?style=social) | Free |
