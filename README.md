...
| ZYRAXON-AI | Desktop AI agent with 357+ tools, 9 agent modes (Build, Research, Debug, Deploy, etc.), eternal memory (survives laptop reset), self-healing, code guardian, Monaco AI assistant, TTS, voice control. 21+ free models, Electron EXE, works offline. | [Github](https://github.com/onelpawarai-X/ZYRAXON-AI) ![GitHub Repo stars](https://img.shields.io/github/stars/onelpawarai-X/ZYRAXON-AI?style=social) | Free |
