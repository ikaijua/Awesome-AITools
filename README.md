...
| Heimdall MCP | Transparent MCP proxy with OpenTelemetry tracing. Wrap any MCP server, persist traces to SQLite · Postgres · MySQL. No code changes needed | [Github](https://github.com/enmanuelmag/heimdall-mcp) ![GitHub Repo stars](https://img.shields.io/github/stars/enmanuelmag/heimdall-mcp?style=social) | Free |
