...
| JasonColapietro/suede-creator-skills | Open-source Agent Skills collection for Claude Code and Codex covering code review and grading, AI evals, CI gates, design, copy, SEO/AEO/GEO, app shipping, and creator rights. | [Github](https://github.com/JasonColapietro/suede-creator-skills) ![GitHub Repo stars](https://img.shields.io/github/stars/JasonColapietro/suede-creator-skills?style=social) | Free |
