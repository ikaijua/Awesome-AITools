...
|SOMA (体悟式智慧架构)|Framework-first cognitive architecture for AI agents with 7 thinking laws and bidirectional memory activation. Self-evolving via meta-learning loop. Python SDK + REST API + Vue3 Dashboard. Apache 2.0.|[Github](https://github.com/sunyan999999/soma) ![GitHub Repo stars](https://img.shields.io/github/stars/sunyan999999/soma?style=social)|Free|
