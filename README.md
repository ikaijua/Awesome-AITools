...
| VibeKit.bot | Build, host, and keep improving web apps entirely from your phone — every app gets its own persistent AI coding agent (Claude or GPT, bring your own key or built-in credits) running on hosted containers with a live URL and custom domains. Native iOS app, web dashboard, and CLI. | [URL](https://vibekit.bot) | Free/Paid |
