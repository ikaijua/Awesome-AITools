...
| nika | Open-source (Rust, AGPL) AI workflow engine: .nika.yaml DAGs statically checked before execution (schema/permits/cost), tamper-evident run traces after, local-first (Ollama/llama.cpp/vLLM, offline mock), MCP client & server | [Github](https://github.com/supernovae-st/nika) ![GitHub Repo stars](https://img.shields.io/github/stars/supernovae-st/nika?style=social) | Free |
