...
| Bernstein | Open-source multi-agent orchestrator for CLI coding agents. Coordinates 37 CLI agents (Claude Code, Codex CLI, Gemini CLI, GitHub Copilot CLI, Cursor, Aider, OpenHands, OpenCode, Goose, Qwen, Ollama, and more) running in parallel git worktrees. Deterministic Python scheduler, first-class MCP server, quality gates, cost tracking with budgets, file-based state. Apache 2.0. | [Github](https://github.com/sipyourdrink-ltd/bernstein) ![GitHub Repo stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein?style=social) | Free |
