...
| qwen-audio-agent | Open-source realtime full-duplex voice frontend for AI coding agents. Talk hands-free to Claude Code, Codex, OpenCode and other ACP agents, with barge-in, background task results read back into the conversation, and a fully local wake word. Ships a macOS desktop orb, terminal TUI, and web UI. | [Github](https://github.com/QwenAudio/qwen-audio-agent) ![GitHub Repo stars](https://img.shields.io/github/stars/QwenAudio/qwen-audio-agent?style=social) | Free |
...
|qwen-audio-agent|Open-source realtime full-duplex voice runtime with natural barge-in and a fully local wake word. Bridges voice conversations with AI coding agents (Claude Code, Codex, OpenCode over ACP), keeps talking while background tasks run, and reads results back into the conversation. macOS desktop orb, terminal TUI, and web UI.|[Github](https://github.com/QwenAudio/qwen-audio-agent) ![GitHub Repo stars](https://img.shields.io/github/stars/QwenAudio/qwen-audio-agent?style=social)|Free|
