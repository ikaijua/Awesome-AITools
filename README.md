...
| CCHub | Desktop application for managing the Claude Code ecosystem with a visual GUI. Features MCP server management, skill management, multi-config switching, custom slash commands, and built-in JSON config editing. Built with Tauri v2 + React + TypeScript + Rust (~5MB installer). | [Github](https://github.com/Moresl/cchub) ![GitHub Repo stars](https://img.shields.io/github/stars/Moresl/cchub?style=social) | Free |
