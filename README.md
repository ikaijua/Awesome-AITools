...
- [ClawRouters](https://www.clawrouters.com) - AI model router & LLM gateway. Routes to 50+ models with sub-10ms latency, saves 60-90% on API costs. Free BYOK tier.
- [OneClaw](https://www.oneclaw.net) - One-click deploy personal AI assistants. 40+ templates, multi-model support (Claude, GPT-4, Gemini), Telegram/Discord/WhatsApp integration.
