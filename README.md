...
| claw-army/claude-node | Python subprocess bridge for Claude Code CLI, giving Python code direct access to Claude Code native capabilities via stream-json. |[Github](https://github.com/claw-army/claude-node) ![GitHub Repo stars](https://img.shields.io/github/stars/claw-army/claude-node?style=social)|Free|
