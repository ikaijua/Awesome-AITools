...
|Antigravity|Google's agent-first AI coding platform built around Gemini 3, the successor to Gemini CLI. Delivered as a heavily modified VS Code-based IDE (a Windsurf derivative) with Editor and Manager views, autonomous agents that drive the editor/terminal/browser, and verifiable Artifacts (plans, screenshots, recordings). Also supports Claude Sonnet 4.6, Claude Opus 4.6, and GPT-OSS-120B. [Intro](docs/antigravity/README.md)|[URL](https://antigravity.google/)|Free during preview|
...
| HagiCode | Local-first AI coding workspace with proposal workflows, multi-agent execution, and multi-repository coordination. | [URL](https://hagicode.com/) , [Github](https://github.com/HagiCode-org) | Free |
