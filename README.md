...
| Nimbalyst | Open-source visual workspace for building with Codex, Claude Code. Manage your agents, sessions, tasks, and files, run multiple agents in parallel on isolated git worktrees, and review their work as red/green diffs you accept or reject. Visually edit markdown, mockups, diagrams, and code, and extend the editor. | [URL](https://nimbalyst.com) [Github](https://github.com/nimbalyst/nimbalyst) ![GitHub Repo stars](https://img.shields.io/github/stars/nimbalyst/nimbalyst?style=social) | Free |
