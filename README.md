...
| Muse Code | Meta's beta terminal coding agent powered by Muse Spark 1.2. Plans changes, writes code, and validates results across large repos using persistent async background agents and an append-only event log. macOS/Linux; pay-as-you-go with an optional Contributor tier that exchanges lower pricing for training-data permission. [Intro](docs/muse-code/README.md) | [URL](https://www.meta.ai/muse/code) | Free/Paid |
