...
| SandBase CLI | Open-source TypeScript CLI and local MCP server connecting ChatGPT, Claude Code, Cursor, Codex, and other clients to 2,000+ AI models and APIs. | [GitHub](https://github.com/sandbaseai/cli) <br> ![GitHub Repo stars](https://img.shields.io/github/stars/sandbaseai/cli?style=social) | Free |
