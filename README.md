...
| HoverStare | Open-source (1PL), repo-aware AI PR review bot written in Rust. The agent uses read-only repo tools to verify before reporting, with multi-pass voting + verifier for low false positives; precise inline comments, incremental tracking with auto-resolve. Ships as GitHub Action, App, or self-hostable webhook service. Works with Anthropic or any OpenAI-compatible endpoint (Kimi, DeepSeek, OpenRouter) | [GitHub](https://github.com/liuchong/hoverstare) <img alt="GitHub Repo stars" src="https://img.shields.io/github/stars/liuchong/hoverstare?style=social"> | Free |
