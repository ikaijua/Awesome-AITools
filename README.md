...
| Bifrost | LLM gateway with a unified API across providers, routing, load balancing, fallbacks, guardrails, and observability. | [Github](https://github.com/maximhq/bifrost) ![GitHub Repo stars](https://img.shields.io/github/stars/maximhq/bifrost?style=social) | Free |
