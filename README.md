...
|TideMind|Open-source AI memory layer with a living knowledge graph. Connects AI tools and notes via MCP. Local-first, SQLite-backed.|[Github](https://github.com/SawyerHan-AI/TideMind) ![GitHub Repo stars](https://img.shields.io/github/stars/SawyerHan-AI/TideMind?style=social)|Free|
