...
|Registry Broker|**Tool Name & URL:** [Registry Broker](https://hol.org/registry/docs) <br> **Core Features:** Universal AI-agent discovery and search across NANDA, MCP, Virtuals, A2A, Olas, and ERC-8004 with a single API and protocol federation layer; trust scoring and interoperability across systems. <br> **Key Differentiators:** Built as a registry broker for multi-protocol AI ecosystems with a unified discovery layer instead of a single-framework runtime. <br> **Target Users:** Developers, platform builders, enterprise AI integrators, and teams running agent marketplaces or discovery layers. <br> **Getting Started:** Install using the project docs and follow the published setup instructions to connect the Registry Broker MCP server. <br> **Pricing:** Free (open-source, Apache-2.0). <br> **Other:** Public MCP server package for registries and AI-agent discovery workflows.|[Docs](https://hol.org/registry/docs), [Github](https://github.com/hashgraph-online/hashnet-mcp-js) ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/hashnet-mcp-js?style=social)|Free|
