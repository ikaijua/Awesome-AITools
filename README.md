...
| Smart-AI-Bot | AI-agent platform for Android UI test automation — runs plain-language test cases on real devices with visual replay reports. |[GitHub](https://github.com/rejigtian/Smart-AI-Bot) | Free |
