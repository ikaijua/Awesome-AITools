...
| AI Dictation | Cross-platform voice-to-text app with MIT-licensed native client source, offline recognition on supported devices, and optional cloud transcription and cleanup. | [URL](https://aidictation.com) <br> [GitHub](https://github.com/writingmate/aidictation) | Free/Paid |
