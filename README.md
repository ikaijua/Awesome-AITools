...
| Clawdbot.tech | Multilingual (中文 / English / 日本語 / Español / Português) deployment archive for OpenClaw (formerly Clawdbot/Moltbot) — covers 5-country self-hosting guides, security whitepaper, rename history, and 700+ skill registry. Companion to the OpenClaw main repo above for non-English-speaking users. | [URL](https://clawdbot.tech/) | Free |
...
|ChatGPT-Next-Web|One-Click to get a well-designed cross-platform ChatGPT web UI, with GPT3, GPT4 & Gemini 3.5 Flash support.|[Github](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) ![GitHub Repo stars](https://img.shields.io/github/stars/ChatGPTNextWeb/ChatGPT-Next-Web?style=social)|Free|
