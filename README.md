...
| agenttrace | Local TUI observability for AI coding agents. Reviews Claude Code, Codex CLI, Gemini CLI, Aider, Cursor, OpenCode, OpenClaw and other session logs across cost, tokens, latency, tool failures, anomalies, health, and CI reports. | [Github](https://github.com/luoyuctl/agenttrace) ![GitHub Repo stars](https://img.shields.io/github/stars/luoyuctl/agenttrace?style=social) | Free |
