...
| Agent Island | Status companion for AI coding agents. Reads the session logs Claude Code, Codex, Antigravity, Grok and Cursor already write locally, shows per-session state in the menu bar or notch, alerts you when a run is waiting on your turn, and computes quota and estimated cost on-device. No account and no product telemetry. Native macOS and Windows, MIT. | [URL](https://agent-island.dev) [Github](https://github.com/tristan666666/agent-island) ![GitHub Repo stars](https://img.shields.io/github/stars/tristan666666/agent-island?style=social) | Free |
