...
| SandBase CLI | Open-source, agent-first CLI and MCP bridge for discovering and running 2,000+ AI models and APIs. Supports multimodal generation, sandbox execution, structured JSON output, OAuth, and 17+ MCP clients through one account. | [Github](https://github.com/sandbaseai/cli) ![GitHub Repo stars](https://img.shields.io/github/stars/sandbaseai/cli?style=social) | Free, API usage requires credits |
