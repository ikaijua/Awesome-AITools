...
| Clarvia | MCP server quality scanner and AEO (Agent Experience Optimization) scoring platform. Scans 27,900+ MCP servers and APIs, scores them 0-100 for AI-agent readiness, and provides embeddable badges. Use before calling any external API to check if it is agent-friendly. Works with Claude Code, Cursor, Windsurf, and any MCP-compatible client. | [Website](https://clarvia.art) [npm](https://www.npmjs.com/package/clarvia-mcp-server) | Free |
