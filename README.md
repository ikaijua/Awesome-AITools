...
| Agent Powerups | Toolkit for coding agents with reusable skills, slash commands, hooks, MCP configs, AGENTS.md templates, workflows, plugin bundles, and the `apx` CLI. Supports Claude Code, Codex, Gemini CLI, and similar workflows. | [Github](https://github.com/yeaight7/agent-powerups) ![GitHub Repo stars](https://img.shields.io/github/stars/yeaight7/agent-powerups?style=social) | Free |
