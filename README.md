...
|ChatGPT-Next-Web|One-Click to get a well-designed cross-platform ChatGPT web UI, with GPT3, GPT4 & Gemini 3.6 Flash support|[Github](https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web) ![GitHub Repo stars](https://img.shields.io/github/stars/ChatGPTNextWeb/ChatGPT-Next-Web?style=social)|Free|
...
| ChatVault | Convert your ChatGPT or Claude conversation export (conversations.json) into clean, readable, printable PDFs. Runs entirely in your browser, so your conversations are never uploaded. Export one conversation, all combined, or each as its own named PDF. | [URL](https://chat-export-seven.vercel.app/) [Github](https://github.com/ImmortalDemonGod/chatvault) ![GitHub Repo stars](https://img.shields.io/github/stars/ImmortalDemonGod/chatvault?style=social) | Free/Paid |
