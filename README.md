...
| --- | --- | --- | --- |
| ChatGPT | 🌟 OpenAI's AI assistant. Current flagship: **GPT-5.6 Sol**. **Differentiation:** persistent memory and user profile — remembers context across conversations and feels the most personalized; best general-purpose assistant for coding, writing, and daily tasks. [Intro](docs/chatgpt/README.md) | [URL](https://chatgpt.com) | Free/Paid |
| Gemini | 🌟 Google's AI assistant. Current flagship: **Gemini 3.7 Flash**. **Differentiation:** native multimodality and Deep Research — best for image understanding/generation and web-based research; tightly integrated with Google Drive and Workspace. [Intro](docs/gemini/README.md) | [URL](https://gemini.google.com/) | Free/Paid |
| Claude | 🌟 Anthropic's AI assistant. Current flagship: **Claude Opus 5**. **Differentiation:** Cowork mode turns the chatbot into an agent that can pull financial data, build Excel forecasting models, and execute workflows; strongest at coding, long-context reasoning, safety, and enterprise use. [Intro](docs/claude/README.md) | [URL](https://claude.ai/) | Free/Paid |
| DeepSeek | DeepSeek's AI assistant. Current flagship: **DeepSeek-V4-Pro** (0813 GA, V4-Pro-Max reasoning mode available; also offers V4-Flash-Vision-Exp as of Aug 21). **Differentiation:** reasoning-to-cost ratio — Pro-Max is the current top open-source model on coding and agentic benchmarks; same 1M context window and native multimodality at very low API cost. | [URL](https://chat.deepseek.com/) | Free/Paid |
| Kimi Chat | Moonshot AI's AI assistant. Current flagship: **Kimi K3**. **Differentiation:** 2.8T-parameter MoE + 1M-token context — optimized for software engineering, repository-scale analysis, and long-document reasoning. | 1. [Kimi](https://kimi.moonshot.cn/)<br>2. [Moonshot AI](https://platform.moonshot.cn/) | Free |
| GLM | Zhipu AI's AI assistant. Current flagship: **GLM-5.3** (743B MoE, 40B active, released Aug 14, 2026); also offers **GLM-5.3-Flash** (320B/18B MoE, native multimodal, MIT open weights, 1M context) with coding/agent performance near Claude Opus 4.8 at much lower cost. **Differentiation:** agentic coding, repo-scale analysis, cyber-defense, and long-context reasoning. | 1. [URL](https://chat.z.ai/)<br>2. [API](https://open.bigmodel.cn/) | Free/Paid |
...
| DeepSeek-V4 | 🌟 DeepSeek's 4th generation flagship model, MIT-licensed and open-weight on Hugging Face. **V4-Pro 0813 GA** rolled out Aug 13, 2026; V4-Pro (1.6T MoE, 49B activated) and V4-Flash (284B MoE, 13B activated) share a 1M-token context and native multimodality, and **V4-Flash-Vision-Exp** was added Aug 21. Architecture upgrades: Hybrid Attention (CSA + HCA) cuts long-context inference FLOPs to ~27% of V3.2 and KV cache to ~10%; Manifold-Constrained Hyper-Connections (mHC) stabilizes residuals; Muon optimizer for faster convergence. Pre-trained on 32T+ tokens. Each model ships with three reasoning effort modes — **Non-think** (fast), **Think High**, and **Think Max** — where **Pro-Max** is currently the strongest open-source model on coding and agentic benchmarks. [Intro](docs/deepseek-v4/README.md) |[Hugging Face](https://huggingface.co/collections/deepseek-ai/deepseek-v4)|Free|
...
| Muse Glimmer | Meta's 30B-parameter open-weight multimodal model for local agents, released Aug 10, 2026 under Apache 2.0. Features ~131K context, text/image input, tool use, 4-bit quantized variants for 24–32 GB VRAM, and DFlash speculative decoding. Distilled from Muse Spark. [Intro](docs/muse-glimmer/README.md) | [Hugging Face](https://huggingface.co/meta-models/Muse-Glimmer-30B) | Free |
| Llama 4 | Meta's latest open-weight multimodal model family. Features mixture-of-experts architecture with variants such as Scout (10M-token context) and Maverick (400B total/17B active params), supporting text and image input. |[GitHub](https://github.com/meta-llama/llama-models) ![GitHub Repo stars](https://img.shields.io/github/stars/meta-llama/llama-models?style=social)| Free |
...
| Phi-4 | Microsoft's open-weight small language model (SLM) family. Includes general, reasoning, multimodal, and vision variants (e.g., Phi-4-mini, Phi-4, Phi-4-multimodal, Phi-4-reasoning-vision) designed for efficient on-device and cloud deployment. | [Github](https://github.com/microsoft/Phi-4CookBook) ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/Phi-4CookBook?style=social) | Free |
...
|Artificial Analysis|Artificial Analysis is a platform that provides AI model and service provider comparisons and benchmarks to help users make informed decisions when choosing AI models and service providers. The platform provides comparative data on a wide range of popular AI models, including OpenAI's GPT-4, Meta's Llama 4, and Anthropic's Claude series, covering performance metrics such as response time, latency, and cost.|[URL](https://artificialanalysis.ai/)|Free|
...
| browser-use | Open-source Python library that enables AI agents to control web browsers. Supports natural-language task execution, DOM extraction, form filling, multi-step navigation, and integration with any LLM via a simple API. Useful for building web agents, automated testing, and data extraction workflows. [Intro](docs/browser-use/README.md) | [GitHub](https://github.com/browser-use/browser-use) ![GitHub Repo stars](https://img.shields.io/github/stars/browser-use/browser-use?style=social) | Free |
...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| Cursor | 🌟 A collaborative code editor using GPT. [Intro](docs/cursor/README.md) | [URL](https://www.cursor.so) | Paid/Free Trial |
...
| code-review-graph | Builds a structural code graph with Tree-sitter, tracks incremental changes, and exposes precise review context to AI coding assistants via MCP to reduce redundant codebase reads. | [Github](https://github.com/tirth8205/code-review-graph) ![GitHub Repo stars](https://img.shields.io/github/stars/tirth8205/code-review-graph?style=social) | Free |
...
| DeepAudit | China's first open-source multi-agent system for code vulnerability discovery. Autonomous collaborative auditing with automated sandboxed PoC verification, one-click deployment, and supports Ollama private deployment. | [Github](https://github.com/lintsinghua/DeepAudit) ![GitHub Repo stars](https://img.shields.io/github/stars/lintsinghua/DeepAudit?style=social) | Free |

### General LLM Applications
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| Google AI Studio|Google AI Studio is a free, web-based developer tool that enables you to quickly develop prompts using the latest Gemini 3.7 Flash models and then get an API key to use in your app development. [Available regions](https://ai.google.dev/gemini-api/docs/available-regions#available_regions)|[URL](https://aistudio.google.com/)|Free|
...
| Honcho | Memory library for building stateful agents. Provides persistent user memory, conversation context, and retrieval for AI agent applications. | [Github](https://github.com/plastic-labs/honcho) ![GitHub Repo stars](https://img.shields.io/github/stars/plastic-labs/honcho?style=social) | Free |
...
| Dify | Open-source LLM app development platform. Visually build AI apps, agents, and workflows with prompt engineering, RAG, model orchestration, and observability. Self-hostable or use the managed cloud. [Intro](docs/dify/README.md) | [URL](https://dify.ai/) [Github](https://github.com/langgenius/dify) ![GitHub Repo stars](https://img.shields.io/github/stars/langgenius/dify?style=social) | Free/Paid |
...
| Nano Banana | 🌟 Google's advanced AI model family for image generation and editing. **Nano Banana Pro** (Gemini 3 Pro Image) is the flagship for highest-quality compositions; **Nano Banana 2** (Gemini 3.1 Flash Image) is the fast tier. Both rank at the top of the LMArena Text-to-Image and Image-Edit leaderboards. Online websites: <br> 1. [gemini](https://gemini.google.com/app)<br> 2. [aistudio](https://aistudio.google.com/prompts/new_chat?model=gemini-3.1-flash-image-preview)   <br> 3. [lmarena.ai](https://lmarena.ai/?mode=direct&chat-modality=image) | [URL](https://aistudio.google.com/prompts/new_chat?model=gemini-3.1-flash-image-preview) | Free/Paid |
| Grok Imagine | SpaceXAI's image generation model (formerly Grok Image / Aurora), integrated in Grok and X. **Grok Imagine Image 2.0** (released Aug 7, 2026) adds precision editing, multi-reference blending, and smart resizing. | [URL](https://grok.com/imagine) | Free/Paid |
...
| clipdrop | clipdrop by Stability AI. Has many AI image processing tools, now powered by **Stable Diffusion 3.5** / Stable Image Ultra (previously Stable Diffusion XL), including uncrop, reimage, and stable doodle. | [URL](https://clipdrop.co/) | Free/Paid |
| firefly | Adobe's AI image processing web site |[URL](https://firefly.adobe.com/)|Free/Paid|
| ideogram.ai | Enter text to create pictures. Current generation **Ideogram 3.0** (released Mar 26, 2025). A product developed by a company founded by many ex-Googlers. | [URL](https://ideogram.ai/) | Free/Paid |
...
| Wan 3.0 | Alibaba's all-in-one video generation model. Supports text, image, video, audio, document, and web references; up to 20 reference inputs; up to 30-second single-pass generation; pixel-level consistency; and precise video editing. | [URL](https://create.wan.video/) | Free/Paid |
| KLING AI | AI Video Creation Tool by Kuaishou, powered by **Kling 3.0** (fully rolled out Jan 31, 2026; Turbo/Omni upgraded Jun 17, 2026; native 4K added Apr 23, 2026). Supports text-to-video, image-to-video, start-end frame and motion control. | [URL](https://klingai.com/) | Free/Paid |
...
| AutoClip | AI-powered video clipping and highlight generation tool. Automatically extracts highlights from videos, ideal for content creation. | [Github](https://github.com/zhouxiaoka/autoclip) ![GitHub Repo stars](https://img.shields.io/github/stars/zhouxiaoka/autoclip?style=social) | Free |
...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| IndexTTS | Bilibili's open-source industrial-grade controllable zero-shot text-to-speech system. Current flagship: **IndexTTS-2.5** supports Chinese, English, Japanese, Spanish, and Arabic with emotion control, speaking-speed control, and Pinyin/CMU/Japanese-Kana pronunciation control. Faster inference than 2.0; deployable via vLLM. <br>Online Demo: https://huggingface.co/spaces/IndexTeam/IndexTTS-2.5-Demo <br>Paper: https://arxiv.org/abs/2601.03888 | [Github](https://github.com/index-tts/index-tts) ![GitHub Repo stars](https://img.shields.io/github/stars/index-tts/index-tts?style=social) | Free |
...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| ElevenLabs | Industry-leading AI voice synthesis and voice conversion tool. Current flagship **Eleven v3** is generally available; offers highly realistic text-to-speech, voice cloning (with just a few minutes of audio), and voice changing capabilities. Supports multiple languages and emotional speech. | [URL](https://elevenlabs.io/) | Free/Paid |
...
| --- | --- | --- | --- |
| suno.ai | The AI music creation tool Suno can generate custom songs based on text prompts in mere seconds. Current generation **Suno v5.5** (released Mar 26, 2026). | [URL](https://www.suno.ai/) | Free/Paid |
...
| mureka.ai | AI music creation tool. Current flagship **Mureka V9** (released 2026). | [URL](https://www.mureka.ai/) | Free/Paid |
...
| Stable Audio | AI music and sound effect generation application by Stability AI. Current generation **Stable Audio 3.0** (released May 20, 2026). | [URL](https://www.stableaudio.com/) | Free/Paid |
