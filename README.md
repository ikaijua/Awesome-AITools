...
| intentic | Self-hosted workspace for running coding agents in parallel on your own hardware. Each agent gets its own Docker container and git worktree; runs continue after you disconnect, any browser or phone reopens the same fleet, and every change is reviewed as a per-file, per-hunk diff before it lands. Runs Claude Code, Codex, OpenCode and Gemini CLI on your own subscriptions. | [URL](https://intentic.dev) [Github](https://github.com/intentic/intentic) ![GitHub Repo stars](https://img.shields.io/github/stars/intentic/intentic?style=social) | Free |
