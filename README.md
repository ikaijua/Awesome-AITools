...
|ClaudeMe|Open-source fork of Claude Code that supports any OpenAI-compatible API. Multi-provider model config in a single JSON file, built-in personal wiki knowledge base with LLM entity extraction and 2-stage RAG query, native Chinese UI, and default bypass-permissions mode. Runs on Bun.|[Github](https://github.com/zrt-ai-lab/claudeme) ![GitHub Repo stars](https://img.shields.io/github/stars/zrt-ai-lab/claudeme?style=social)|Free|
