...
| XiuRouter | Multi-model API service for applications and coding tools. Supports OpenAI Responses and Chat Completions, Anthropic Messages, and Gemini GenerateContent, with usage-based pricing, scoped API keys, per-request usage and cost records, and client setup guides. | [URL](https://router.xiu.ai/) [Docs](https://docs.xiu.ai/en/router/) | Paid |
