...
|SwarmClaw|Self-hosted AI runtime for multi-agent orchestration. Provides heartbeats, schedules, delegation, memory, and runtime skills across OpenClaw, Claude Code, Codex, Gemini CLI, OpenCode, Copilot CLI, Cursor Agent, Goose, Qwen Code, Droid, and major LLM providers. Ships as a desktop app (Electron) and CLI.|[Github](https://github.com/swarmclawai/swarmclaw) ![GitHub Repo stars](https://img.shields.io/github/stars/swarmclawai/swarmclaw?style=social)|Free|
