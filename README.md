...
| claude-skills-pro | 15 engineering-workflow skills for Claude Code and 75+ agents (7-dimension code review, root-cause debugging, test generation, feature specs, security audit, safe refactoring, API design). 7 skills free/MIT, Pro pack with Chinese handbook is paid. Real output examples in repo. | [Github](https://github.com/Hahaknight/claude-skills-pro) ![GitHub Repo stars](https://img.shields.io/github/stars/Hahaknight/claude-skills-pro?style=social) | Free/Paid |
| digital-employee-pack | Chinese office-productivity skills pack for non-programmers: weekly report generator, meeting minutes, spreadsheet cleaning, plus safety hooks and Chinese SOP. Works with Claude Code and 75+ agents. | [Github](https://github.com/Hahaknight/digital-employee-pack) ![GitHub Repo stars](https://img.shields.io/github/stars/Hahaknight/digital-employee-pack?style=social) | Free/Paid |
