...
| CiteMe | Academic citation generator with a reference checker that flags fabricated references. Searches 10+ databases (OpenAlex, PubMed, Semantic Scholar, CrossRef) and formats references in 60 curated citation styles (APA, ABNT, MLA, Chicago, Vancouver). Available as web app and Chrome extension | [URL](https://citeme.app)| Free/Paid |
