...
|Agent Gateway|Unified API proxy for AI agents — one endpoint to access 39+ infrastructure services including web search, scraping, screenshots, code execution, crypto wallets, email, file storage, and more. Built-in authentication, rate limiting, and usage tracking.|[URL](https://agent-gateway-kappa.vercel.app)|Free/Paid|
