...
| Awesome Agentic Engineering | MIT-licensed production-readiness toolkit for AI agents, not a resource list. Provides a zero-dependency score and risk-profile GitHub Action, fail-closed initializer, prompt-injection fixtures, machine-readable eval results, and reproducible LangGraph traces. [Guide](https://lindixu6-hash.github.io/awesome-agentic-engineering/langgraph-eval/) | [Github](https://github.com/lindixu6-hash/awesome-agentic-engineering) ![GitHub Repo stars](https://img.shields.io/github/stars/lindixu6-hash/awesome-agentic-engineering?style=social) | Free |
