...
| The Stall | x402 pay-per-call MCP server for AI agents — 280 capabilities: US/EU/JP/KR/AU equities, options chains (dealer GEX), DeFi yields, blockchain analytics, macro indicators (FRED/Treasury/FX), wallet risk intelligence, prediction markets, GDELT news synthesis, and more. USDC on Base, $0.001–$1.50/call. No API key required. | [Github](https://github.com/thebrierfox/the-stall) ![GitHub Repo stars](https://img.shields.io/github/stars/thebrierfox/the-stall?style=social) | Pay-per-call |
