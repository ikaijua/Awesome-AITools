...
| AgentReady | AI readiness scanner that scores any website on 8 factors (llms.txt, ai.txt, schema markup, MCP protocol, bot accessibility, and more). Provides actionable recommendations and industry benchmarks for AI agent compatibility. | [URL](https://agentready.site) | Free/Paid |
