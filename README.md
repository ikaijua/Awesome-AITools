...
| Qwen3.8-27B | 🌱 Alibaba's 27B dense multimodal open-weight model. Supports text/image/video input, 262K-token context, Apache 2.0 license, optimized for coding and agentic tasks on consumer GPUs. | [HuggingFace](https://huggingface.co/Qwen/Qwen3.8-27B) [GitHub](https://github.com/QwenLM/Qwen3.8) ![GitHub Repo stars](https://img.shields.io/github/stars/QwenLM/Qwen3.8?style=social) | Free |
