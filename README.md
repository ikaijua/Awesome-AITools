...
| LingtiStudio | Open-source local-first AI video production system that turns a topic into script, keyframes, voiceover, clips, subtitles, and final video output. | [Github](https://github.com/ruilisi/LingtiStudio) ![GitHub Repo stars](https://img.shields.io/github/stars/ruilisi/LingtiStudio?style=social) | Free |
