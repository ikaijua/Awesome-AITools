...
| Tura | Tura is a local, open-source coding agent for developers who are tired of vague skill claims, token-saving extensions with no evidence, and agents that change a repository before understanding it. | [Github](https://github.com/Tura-AI/tura) ![GitHub Repo stars](https://img.shields.io/github/stars/Tura-AI/tura?style=social) | Free |
