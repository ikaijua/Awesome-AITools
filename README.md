...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
|Browy|Open-source AI agent that lives in your browser as a Chrome/Edge/Brave extension. Drives your real logged-in tabs through the Chrome DevTools Protocol. Side panel chat plus a terminal-style DevTools CLI. Powered by your existing GitHub Copilot subscription, no extra API keys.|[Github](https://github.com/BrowyHQ/browy) ![GitHub Repo stars](https://img.shields.io/github/stars/BrowyHQ/browy?style=social), [Docs](https://browyhq.github.io/)|Free|
