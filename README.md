...
| UIZZE | Gives coding agents real UI context before implementation: browse a public library of web and iOS product UI references, then use hosted MCP workflows for design contracts, implementation validation, audits, and critiques. | [URL](https://uizze.com) [Docs](https://uizze.com/docs) | Free/Paid |
