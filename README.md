...
| Ontoly | TypeScript-native software intelligence engine that builds deterministic Software Graphs and exposes CLI, MCP, and Agent Skills for architecture review, request tracing, dependency analysis, and impact analysis. | [Github](https://github.com/0xsarwagya/ontoly) ![GitHub Repo stars](https://img.shields.io/github/stars/0xsarwagya/ontoly?style=social) | Free |
