...
| LWC (Local Wiki CLI) | Local-first, source-grounded project memory for coding agents. Stores durable Markdown/SQLite knowledge with citations and provenance, exposes bounded read-only retrieval through MCP, and optionally builds document and code knowledge graphs. Supports Codex, Claude Code, Cursor, OpenCode, Gemini CLI, Kiro, Hermes, Antigravity, and pi. | [Github](https://github.com/JanYork/llm-wiki-cli) ![GitHub Repo stars](https://img.shields.io/github/stars/JanYork/llm-wiki-cli?style=social) | Free |
