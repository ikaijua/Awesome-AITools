...
| Meander | AI voice dictation that runs natively on Linux, Windows & Android (full keyboard): push-to-talk, AI cleanup, and translation that speaks one language and outputs another. | [URL](https://everydays.tools/meander) | Free/Paid |
