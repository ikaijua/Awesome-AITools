...
| Nimbalyst | Open-source visual workspace for building with Codex and Claude Code. Run agent sessions in parallel, review their edits as red/green diffs inside human editable rendered markdown, mockups, diagrams, and track tasks in the same workspace with agents. | [Github](https://github.com/nimbalyst/nimbalyst) ![GitHub Repo stars](https://img.shields.io/github/stars/nimbalyst/nimbalyst?style=social)|Free|
