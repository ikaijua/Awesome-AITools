...
|dna-claude-analysis|Personal genome analysis toolkit that uses LLM to analyze raw DNA data across 17 categories (ancestry, health risks, nutrition, fitness, longevity, pharmacogenomics, and more) and generates a terminal-style single-page HTML visualization.|[Github](https://github.com/shmlkv/dna-claude-analysis) ![GitHub Repo stars](https://img.shields.io/github/stars/shmlkv/dna-claude-analysis?style=social)|Free|
