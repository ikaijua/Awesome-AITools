...
| Open Index | Open-source structured context layer for domain-specific AI agents. Builds searchable, continuously improving context graphs from typed schemas, entities, and relationships, with SQLite or OpenSearch backends, connectors, a CLI/UI, and a read/write MCP interface. | [Github](https://github.com/DrDroidLab/open-index) ![GitHub Repo stars](https://img.shields.io/github/stars/DrDroidLab/open-index?style=social) | Free |
