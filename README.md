...
| NarraNexus | Open-source AI agent team workspace by NetMind.AI — agents that remember, collaborate, and use tools from day one. Persistent memory across sessions, multi-agent collaboration (PM, developer, deployment, research), and MCP-style tool integrations. Cloud, macOS, and local source deployment. | [Github](https://github.com/NetMindAI-Open/NarraNexus) ![GitHub Repo stars](https://img.shields.io/github/stars/NetMindAI-Open/NarraNexus?style=social) [URL](https://www.narra.nexus/) | Free |
