...
| LocalGateway | Zero-dependency desktop LLM gateway CLI with multi-provider automatic failover. Routes across OpenAI, Anthropic, DeepSeek, Groq. Local proxy for Cursor, Claude Desktop, Windsurf. | [GitHub](https://github.com/Correctover/local-gateway) | Free |
