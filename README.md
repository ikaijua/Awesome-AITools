...
| Agent Harness Kit | Scaffolding for structured multi-agent workflows — MCP server, health gate, audit trail, no cloud | [Github](https://github.com/enmanuelmag/agent-harness-kit) ![GitHub Repo stars](https://img.shields.io/github/stars/enmanuelmag/agent-harness-kit?style=social) | Free |
