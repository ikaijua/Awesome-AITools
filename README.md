...
| Repo Agent Kit | Free browser toolkit for generating, auditing, and converting repository instruction files such as AGENTS.md and CLAUDE.md. Includes public-repository analysis and copy-ready templates; pasted text stays in the browser. | [Website](https://repoagentkit.com) [Starter Kit](https://github.com/sunxiayi/agents-md-starter-kit) ![GitHub Repo stars](https://img.shields.io/github/stars/sunxiayi/agents-md-starter-kit?style=social) | Free |
