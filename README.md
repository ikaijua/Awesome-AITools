...
|OpenRelay|Local multi-provider AI proxy, connects 28 providers (Claude/GPT/Groq/Gemini etc.) to any AI tool via unified API|[GitHub](https://github.com/romgX/openrelay) ![GitHub Repo stars](https://img.shields.io/github/stars/romgX/openrelay?style=social)|Free|
