...
| avoid-ai-writing | Audits and rewrites content to remove AI writing patterns. Detects 34 pattern categories with a 103-entry tiered vocabulary, severity levels for triage, and content-type profiles that adjust strictness for LinkedIn, blogs, technical docs, and investor emails. | [Github](https://github.com/conorbronsdon/avoid-ai-writing) ![GitHub Repo stars](https://img.shields.io/github/stars/conorbronsdon/avoid-ai-writing?style=social) | Free |
