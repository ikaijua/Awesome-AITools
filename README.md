...
|AgentFund|Crowdfunding platform for AI agents. Milestone-based escrow on Base chain. MCP server lets agents create funding proposals, track projects, and receive payments.|[Github](https://github.com/RioTheGreat-ai/agentfund-mcp) ![GitHub Repo stars](https://img.shields.io/github/stars/RioTheGreat-ai/agentfund-mcp?style=social)|Free|
