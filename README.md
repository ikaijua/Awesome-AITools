...
| llm.log | Local MITM proxy with TUI dashboard for monitoring LLM API calls — token usage, real costs, latency and full request inspector. Supports OpenAI, Anthropic and OpenRouter. Zero code changes, single binary, pure Go. | [Github](https://github.com/lanesket/llm.log) ![GitHub Repo stars](https://img.shields.io/github/stars/lanesket/llm.log?style=social) | Free |
