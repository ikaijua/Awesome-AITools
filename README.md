...
| GLM | Zhipu AI's AI assistant. Current flagship: **GLM-5.3**. **Differentiation:** 743B-parameter MoE (40B active) built for coding and cyber-defense tasks — agentic coding, repo-scale analysis, and long-context reasoning with 1M-token context and up to 128K output. | 1. [URL](https://chat.z.ai/)<br>2. [API](https://open.bigmodel.cn/) | Free/Paid |
...
| Phi-4 | Microsoft's open-weight small language model (SLM) family. Includes general, reasoning, and vision variants (e.g., Phi-4-mini, Phi-4, Phi-4-reasoning-vision) designed for efficient on-device and cloud deployment. |[Github](https://github.com/microsoft/Phi-4CookBook) ![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/Phi-4CookBook?style=social)| Free |
...
| _done | Pay-per-use REST APIs that give AI agents real-world actions (DNS/WHOIS, OCR, screenshots, HTTP/SEO checks, and more) with no accounts, logins, or API keys. Usage starts at $0.01 via x402. | 1. [URL](https://underscoredone.com/)<br>2. [GitHub](https://github.com/underscoredone/x402-tools-skill) ![GitHub Repo stars](https://img.shields.io/github/stars/underscoredone/x402-tools-skill?style=social) | Paid |
### Agent Skills
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
