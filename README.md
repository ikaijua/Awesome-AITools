...
| BitFun | Open-source desktop and CLI coding agent powered by a Rust runtime. It can turn tasks into stateful Agentic Mini Apps, supports multiple model providers and custom Agents, MCP, Skills, and Hooks, and offers self-hostable cross-device access. | [Github](https://github.com/GCWing/BitFun) ![GitHub Repo stars](https://img.shields.io/github/stars/GCWing/BitFun?style=social) | Free |
