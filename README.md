...
| ClaudeCode Launchpad CLI | 2-minute Windows & macOS installer for Claude Code — auto-installs Node.js, Git & Claude Code with zero manual config. Adds a live two-line status bar (model, context %, usage limits with reset timers), desktop shortcut with folder picker, and right-click "Open with ClaudeCode Launchpad CLI" context menu on Windows folders. | [Github](https://github.com/noambrand/kivun-terminal) ![GitHub Repo stars](https://img.shields.io/github/stars/noambrand/kivun-terminal?style=social) | Free |
