...
| Bernstein | Deterministic orchestrator for 40+ CLI coding agents (Claude Code, Codex, Cursor, Aider, Gemini, Copilot, OpenHands, Goose, Qwen, Ollama, and more). Runs them in parallel git worktrees and merges what passes the tests. MCP server, cost budgets, quality gates, file-based state. Apache 2.0. [Site](https://bernstein.run) | [Github](https://github.com/sipyourdrink-ltd/bernstein) ![GitHub Repo stars](https://img.shields.io/github/stars/sipyourdrink-ltd/bernstein?style=social) | Free |
