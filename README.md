...
| Superhighway | Live web search API for AI agents — search, news, images, scrape, and deep research via 5 tools. Agents pay autonomously per call using the x402 protocol (USDC on Base); human operators can use a free API key or Stripe plan. Works with any framework: LangChain, Mastra, Vercel AI SDK, smolagents, and more. | [Web](https://superhighway.walls.sh) [MCP](https://www.npmjs.com/package/superhighway-mcp) | Free/Paid |
