...
| Obscura | Open-source (Apache-2.0) headless browser engine written in Rust for AI agents and web scraping. A drop-in replacement for headless Chrome via the Chrome DevTools Protocol, compatible with Puppeteer/Playwright: ~30 MB memory, instant startup, and a built-in stealth mode with anti-fingerprinting and tracker blocking. | [GitHub](https://github.com/h4ckf0r0day/obscura) ![GitHub Repo stars](https://img.shields.io/github/stars/h4ckf0r0day/obscura?style=social) | Free |
...
| Suede Creator Skills | Open-source 76-skill pack for Claude Code and Codex covering ship-DAG orchestration, A–F code review, AI evals, CI gates, design, copy, SEO/AEO/GEO, app shipping, and creator rights. | [Github](https://github.com/JasonColapietro/suede-creator-skills) ![GitHub Repo stars](https://img.shields.io/github/stars/JasonColapietro/suede-creator-skills?style=social) | Free |
...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| Google AI Studio|Google AI Studio is a free, web-based developer tool that enables you to quickly develop prompts using the latest Gemini 3.8 Flash models and then get an API key to use in your app development. [Available regions](https://ai.google.dev/gemini-api/docs/available-regions#available_regions)|[URL](https://aistudio.google.com/)|Free|
...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| GPT Image |🌟 OpenAI's image generation model GPT Image 2.5 (Sep 2026). ~50% faster, more photorealistic rendering, precise region editing, and a Sketch feature that turns hand-drawn drafts into finished images; API offers GPT-Image-2.5 Flare and Sunburst.|[URL](https://chatgpt.com/images)|Free/Paid|
