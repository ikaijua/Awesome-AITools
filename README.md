...
| Off Grid AI Desktop | Private, local-first macOS app for on-device LLM chat, image generation, voice dictation, and personal memory/RAG - nothing leaves your machine. | [Github](https://github.com/off-grid-ai/off-grid-ai-desktop) ![GitHub Repo stars](https://img.shields.io/github/stars/off-grid-ai/off-grid-ai-desktop?style=social) | Free |
