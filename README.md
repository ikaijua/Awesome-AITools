...
| Claude| Anthropic's LLM, including Claude Opus 4.5|[URL](https://claude.ai/)| Free/Paid|
...
|Registry Broker|**Tool Name & URL:** [Registry Broker](https://hol.org/registry/docs) <br> **Core Features:** Universal AI-agent discovery and search across NANDA, MCP, Virtuals, A2A, Olas, and ERC-8004 with a single API and protocol federation layer; trust scoring and real-time updates for easier interoperability. <br> **Key Differentiators:** Built as a registry broker for multi-protocol AI ecosystems, with universal discovery, virtual-topic addressing, and Hedera-based trust/reputation integration rather than a single-framework agent tool. <br> **Target Users:** Developers, platform builders, enterprise AI integrators, and teams building/operating agent marketplaces or assistants needing cross-network discovery. <br> **Getting Started:** Follow the quick-start in the docs and run via Docker for API, Elasticsearch, and Redis. Includes manual install and configuration notes in the project README. <br> **Pricing:** Free (open-source, Apache-2.0). <br> **Other:** Self-hostable; supports AgentVerse proxy and registry federation workflows from `registry-broker`.|[Docs](https://hol.org/registry/docs), [Github](https://github.com/hashgraph-online/hashnet-mcp-js) ![GitHub Repo stars](https://img.shields.io/github/stars/hashgraph-online/hashnet-mcp-js?style=social)|Free|
...
|MuseGen|An AI music studio for lyric writing and song generation |[URL](https://musegen.org) |Free/Paid|  
