...
| FutureOS | One AI agent everywhere you work — terminal UI, desktop, mobile, CLI, and IM bots from a single Rust backend, with approval-gated tools and a loop control plane for 24h+ runs. | [Github](https://github.com/futuregene/future-os) ![GitHub Repo stars](https://img.shields.io/github/stars/futuregene/future-os?style=social) | Free |
