...
| AI Buddy | Open-source Chrome side panel that sends selected text or annotated screenshots to ChatGPT, Claude, Gemini, DeepSeek, Copilot, WhatsApp, Telegram, or Discord. 10 starter scenarios (Explain, Translate, Summarize, Debug Code, etc.). No backend, uses your existing accounts. | [Chrome Web Store](https://chromewebstore.google.com/detail/ai-buddy/eigpaeoigklelmfgnkljhbjjbpohenpn) · [GitHub](https://github.com/mnbqwe10/ai_buddy) | Free |
