...
| DeepSeek | DeepSeek's AI assistant. Current flagship: **DeepSeek-V4-Pro**. **Differentiation:** reasoning-to-cost ratio — state-of-the-art reasoning (V4-Pro) at extremely low cost; 1M context window and native multimodality. | [URL](https://chat.deepseek.com/) | Free/Paid |
...
| intentic | Self-hosted workspace for running coding agents in parallel on your own hardware. Each agent gets its own Docker container and git worktree; runs continue after you disconnect, any browser or phone reopens the same fleet, and every change is reviewed as a per-file, per-hunk diff before it lands. Runs Claude Code, Codex, Grok and Kimi Code natively, plus OpenCode and Gemini CLI over ACP, on your own subscriptions. | [URL](https://intentic.dev) [Github](https://github.com/intentic/intentic) ![GitHub Repo stars](https://img.shields.io/github/stars/intentic/intentic?style=social) | Free |
...
| Grok Image | xAI's image generation model (Aurora), integrated in Grok and X. Known for photorealistic and meme-style image creation. | [URL](https://grok.com/) | Free/Paid |
