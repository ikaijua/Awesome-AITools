...
| AICraft | Desktop AI capability launcher — manage LLM Skills, MCP tools, RAG, and memory like loading Minecraft mods. Features one-click DeepSeek setup, role emotion portraits, 3-tier memory, token billing, all hot-pluggable via visual UI. Portable, no installation required. | [Github](https://github.com/Easlie114514/AICraft) ![GitHub Repo stars](https://img.shields.io/github/stars/Easlie114514/AICraft?style=social) | Free |
