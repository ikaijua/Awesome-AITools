...
| Name | Description | Links | Fees |
| --- | --- | --- | --- |
| agent-qa | Self-improving QA agent for web and mobile apps. Write tests in natural language, retain run memory, adapt to UI changes, and catch regressions before shipping. | [Github](https://github.com/vostride/agent-qa) ![GitHub Repo stars](https://img.shields.io/github/stars/vostride/agent-qa?style=social) | Free |
