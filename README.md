...
| atdy/maoxuan-product-agent | Chinese-first product decision Agent Skill distilled from the complete reasoning structure of *On Contradiction* and *On Practice* into modern product language. Supports prioritization, growth, operations, data, delivery, and collaboration work across Codex, Claude Code, Cursor, and compatible agents, with 36 scenario tests and 12 searchable case pages. | [Github](https://github.com/atdy/maoxuan-product-agent) ![GitHub Repo stars](https://img.shields.io/github/stars/atdy/maoxuan-product-agent?style=social) | Free |
